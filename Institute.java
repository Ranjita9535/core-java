...
public class Institute{
	...
	int returnedarea=area(18);
	System.out.println(returnedarea);
	
	int returnedarea1=area (5,12);
	System.out.println(returnedarea1);
	
	float returned1getTemperature = getTemperature(3.0f,8.9f);
	System.out.println(returned1getTemperature);
		
	float returned1getTemperature1 = getTemperature(40, 4.7f);
	System.out.println(returned1getTemperature1);
	
	double getResult= getResult(64,(byte)21);	
	System.out.println(getResult);	
		
    double getResult1= getResult((short)30, 60.2d);	
	System.out.println(getResult1);	
		
	int mobileNumber=mobileNumber(23,6);
	System.out.println(mobileNumber);	
		
	int mobileNumber1= mobileNumber(34);
	System.out.println(mobileNumber1);	
		
	int isPositive =isPositive(3,6);
	System.out.println(isPositive);
		
		
	int isPositive1 =isPositive(8,8d);
	System.out.println(isPositive1);	
		
	int isPositive2 =isPositive((short)49,30);
	System.out.println(isPositive2);	
		
	int isPositive3 =isPositive(45,(short)30);
	System.out.println(isPositive3);	
		
	int totalMarks=totalMarks(40,53);
	System.out.println(totalMarks);	
		
	int totalMarks1 =totalMarks(80);
	System.out.println(totalMarks1);	
		
	int scoreOfMatch= scoreOfMatch(47,27);
	System.out.println(scoreOfMatch);	
		
	int scoreOfMatch1= scoreOfMatch(25,(short)50);
	System.out.println(scoreOfMatch1);	
		
	float cgpaOfStudent= cgpaOfStudent (7.0f, 35);
	System.out.println(cgpaOfStudent);	
		
	float cgpaOfStudent1= cgpaOfStudent(10, 3.5f);	
